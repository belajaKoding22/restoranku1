                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-item w-100">
                                        ...
                                        <input type="text" name="fullname" class="form-control" placeholder="Silahkan masukan nama" required>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-item w-100">
                                        <label class="form-label my-3">Nomor WhatsApp<sup>*</sup></label>
                                        <input type="text" name="phone" class="form-control" placeholder="Silahkan masukan nomor whatsapp" required>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-item w-100">
                    ...
                    if (data.snap_token) {
                        snap.pay(data.snap_token, {
                            ...
                            onPending: function(result){
                               alert('Pembayaran tertunda. Silahkan selesaikan pembayaran Anda.');
                            },
                        ...
                        alert('Gagal mendapatkan token pembayaran. Silahkan coba lagi.');
                    }       
                })
                .catch(error => {
                    console.error('Error:', error);
                    alert('Terjadi kesalahan saat memproses pembayaran. Silahkan coba lagi.');
                });
